/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --strict-vars=false` (hash: b38668f9e6976fb7d2152ed8f6803bd1)
...
interface __BaseEnv_Env {
	...
	PLAYBACK_AUTH_ENDPOINT: string;
	PLAYBACK_AUTH_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SUPABASE_URL" | "SPORTS_PROVIDER" | "SPORTS_API_BASE" | "ALLOWED_ORIGINS" | "SUPABASE_SECRET_KEY" | "SPORTS_API_KEY" | "YOUTUBE_API_KEY" | "PLAYBACK_AUTH_ENDPOINT" | "PLAYBACK_AUTH_TOKEN">> {}
}
